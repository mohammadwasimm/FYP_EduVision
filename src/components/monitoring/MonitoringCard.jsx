      ...
      <div className="p-4 bg-white">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col items-center justify-center px-3 py-2 rounded-lg bg-[#F1F5F980] flex-1">
            <BsArrows className="w-4 h-4 text-[#65758B] mb-1" />
            <span className="text-xs text-[#65758B] capitalize">{metrics.movement || "Normal"}</span>
          </div>
          
          {/* Suspicious Card */}
          <div className="flex flex-col items-center justify-center px-3 py-2 rounded-lg bg-[#F1F5F980] flex-1">
            <FiEye className="w-4 h-4 text-[#65758B] mb-1" />
            <span className="text-xs text-[#65758B] capitalize">{metrics.suspicious || "Normal"}</span>
          </div>
          
          {/* Phone Detection Card */}
          <div className="flex flex-col items-center justify-center px-3 py-2 rounded-lg bg-[#F1F5F980] flex-1">
            <MdPhoneIphone className="w-4 h-4 text-[#65758B] mb-1" />
            <span className="text-xs text-[#65758B] capitalize">
