  ...
  return (
    <header className="flex items-center justify-between gap-4 px-6 py-4 border-b border-slate-200 bg-white">
      <div className="min-w-0">
        <h1 className="text-lg sm:text-xl font-semibold text-[#2b3674] truncate">
          {title}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 pl-1">
          <div className="h-10 w-10 rounded-full bg-[#4318ff] text-white flex items-center justify-center font-semibold text-sm">
            AD
          </div>
          <div className="hidden sm:block leading-tight">
            <p className="text-sm font-medium text-[#2b3674]">Admin User</p>
            <p className="text-[11px] text-[#2b3674]">Administrator</p>
          </div>
        </div>
      </div>
    </header>
